      ...
      <div className="container max-w-screen-xl mx-auto py-10 grid lg:grid-cols-2 grow px-5 gap-y-10 gap-x-5">
        <div className="flex flex-col gap-y-3 order-last md:order-first">
          ...
          <div className="inline-flex gap-10 pb-10">
            <p className="inline-flex items-center gap-1 font-bold text-sm text-rich/60 dark:text-white">
          ...
          <div className="inline-flex items-center gap-5">
            ...
            >
              <TbEditCircle className="text-sm sm:text-xl" /> Take Assignment
            </button>
            {user?.email && (
              <button
                type="button"
              ...
              >
                <BiSolidTrash className="text-sm sm:text-xl" /> Delete
              </button>
            )}
          </div>
        </div>
        <div className="w-full h-full relative md:order-last order-first">
          <img
